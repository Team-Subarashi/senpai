...
export default function Splash() {
  ...
  return (
    <Vanta>
      <div style={{height: "92%", display: "flex", flexDirection: "column", justifyContent: "space-between"}}>
        <Grid className={classes.padding} container>
          ...
          <Grid container justifyContent="center" alignItems="center" item xs={6} className={classes.padding}>
            <img src="https://i.imgur.com/HKga5Hs.png" alt="img" style={{width:"100%", maxWidth:"100%", height:"auto"}} />
          </Grid>
        </Grid>
